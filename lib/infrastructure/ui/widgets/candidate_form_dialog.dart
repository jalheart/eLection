    ...
    return DropTarget(
      onDragDone: (details) {
        if (details.files.isNotEmpty) {
          setState(() {
            _imagePath = details.files.first.path;
            _isHovering = false;
          });
        }
      },
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  color: _isHovering ? theme.primaryColor.withOpacity(0.8) : theme.primaryColor,
                                ...
                                child: Container(
                                  ...
                                  child: _imagePath != null
                                      ? ClipRRect(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final isAbsolute = p.isAbsolute(_imagePath!);
                                      ...
                                      : Column(
                                          ...
                                          children: [
                                            Icon(
                                              _isHovering ? Icons.file_download : Icons.image,
                                              size: 40,
                                              color: _isHovering
                                                  ? theme.primaryColor
                                                  : Colors.grey,
                                            ...
                                            Text(
                                              _isHovering ? 'SUELTA LA IMAGEN' : l10n.selectPicture,
                                              style: TextStyle(
                                                color: _isHovering
                                                    ? theme.primaryColor
                                                    : Colors.grey,
